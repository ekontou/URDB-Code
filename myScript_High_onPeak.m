...
taxis=1:1:24; % 24 hours definition
% 
% tpatternkwh=[0 0 0 0 0 0 0 40 40 40 40 40 40 40 40 40 40 40 40 40 40 40 0 0]; %charging energy profile
...
% idxtry = accumarray(gisIDN, TC3, [], @minarg);
% 
...
% ylabel('[$/kWh]')
% title('Avg Cost - High Utilization Small Station (1-plug), on-peak')
% ylim([-0.01 0.8])
% figure
% boxplot( DC ,demandTypeN,'Labels',{'No Demand','Flat Demand','TOU Demand'},'Symbol','o')
% ylabel('[$/kWh]')
% title('Avg Demand Cost - High Utilization Small Station (1-plug), on-peak')
% ylim([-0.01 0.3])
% figure
% boxplot( EC ,demandTypeN,'Labels',{'No Demand','Flat Demand','TOU Demand'},'Symbol','o')
% ylabel('[$/kWh]')
% title('Avg Energy Cost - High Utilization Small Station (1-plug), on-peak')
% ylim([-0.01 0.3])
...
DMeanHighOnPeak=[meand1;meand2;meand3];
EMeanHighOnPeak=[meane1;meane2;meane3];
YCMeanHighOnPeak=[meanY1;meanY2;meanY3];
FMeanHighOnPeak=[meanf1;meanf2;meanf3];

% DMeanHighOnPeak=grpstats(DC,demandTypeN)
% EMeanHighOnPeak=grpstats(EC,demandTypeN)
% YCMeanHighOnPeak=grpstats(YC,demandTypeN)
% FMeanHighOnPeak=grpstats(MF,demandTypeN)
...
% ylim([0 0.6])
% xlim([0 52])
% title('Levelized Electricity Cost Estimates [$/kWh] - No Demand Charges - High Utilization Small Station On Peak')
% ylabel('[$/kWh]')
...
% ylim([0 3.5])
% xlim([0 52])
% title('Levelized Electricity Cost Estimates [$/kWh]- Flat Demand Charges - High Utilization Small Station On Peak')
% ylabel('[$/kWh]')
% set(gca,'Xtick',0:1:52);
% xt_label = get(gca, 'XTick');
% set(gca, 'XTick', xt_label, 'XTickLabel', {'' 'AK' 'AL' 'AR' 'AZ' 'CA' 'CO' 'CT' 'DC' 'DE' 'FL' 'GA' 'HI' 'IA' 'ID' 'IL' 'IN' 'KS' 'KY' 'LA' 'MA' 'MD' 'ME' 'MI' 'MN' 'MO' 'MS' 'MT' 'NC' 'ND' 'NE' 'NH' 'NJ' 'NM' 'NV' 'NY' 'OH' 'OK' 'OR' 'PA' 'RI' 'SC' 'SD' 'TN' 'TX' 'UT' 'VA' 'VT' 'WA' 'WI' 'WV' 'WY' ''})
...
% ylim([0 1.7])
% xlim([0 52])
% title('Levelized Electricity Cost Estimates [$/kWh]- TOU Demand Charges - High Utilization Small Station On Peak')
% ylabel('[$/kWh]')
% set(gca,'Xtick',0:1:52);
% xt_label = get(gca, 'XTick');
% set(gca, 'XTick', xt_label, 'XTickLabel', {'' 'AK' 'AL' 'AR' 'AZ' 'CA' 'CO' 'CT' 'DC' 'DE' 'FL' 'GA' 'HI' 'IA' 'ID' 'IL' 'IN' 'KS' 'KY' 'LA' 'MA' 'MD' 'ME' 'MI' 'MN' 'MO' 'MS' 'MT' 'NC' 'ND' 'NE' 'NH' 'NJ' 'NM' 'NV' 'NY' 'OH' 'OK' 'OR' 'PA' 'RI' 'SC' 'SD' 'TN' 'TX' 'UT' 'VA' 'VT' 'WA' 'WI' 'WV' 'WY' ''})
